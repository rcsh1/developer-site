...
underpins the [Cobo Argus](v1/coboargus), an all-in-one on-chain solution
institution's DeFi investment.

Cobo Safe is deployed on multiple EVM blockchains. Users can use dedicated
[tools](/v1/get-started/tools/pycobosafe), [SDKs](v1/sdks-and-tools/sdks/cobo-safe/python) or [Cobo Argus](coboargus) web interface to
