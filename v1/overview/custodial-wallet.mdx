...
Wallet](mpc-wallet/mpc-introduction) and [Smart Contract Wallet](/overivew/smart-contract-wallet/cobosafe),
...
[Wallet-as-a-Service](/overivew/waas-introduction) API access etc.
...
via HTTP based SaaS APIs. Our [Wallet-as-a-Service (WaaS) ](/overivew/waas-introduction) allows clients
...
[Python](/sdks-and-tools/sdks/waas/python), [JavaScript](v1/sdks-and-tools/sdks/waas/javascript), [Golang](/sdks-and-tools/sdks/waas/go),
[Java](/sdks-and-tools/sdks/waas/java), [PHP](v1/sdks-and-tools/sdks/waas/php) for third-party developers to use.
