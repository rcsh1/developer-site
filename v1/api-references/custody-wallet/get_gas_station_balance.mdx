...
description: <Note>This content applies to WaaS 1.0 only. We highly recommend that you upgrade to [WaaS 2.0](/v2/guides/overview/introduction).</Note> This endpoint returns a list of assets of gas station. The response includes asset details such as coin, address, and balance.
---
