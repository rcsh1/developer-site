...
api: GET /v1/custody/mpc/babylon/babylon_list_transactions_by_status/
contentType: multipart/form-data
description: "This endpoint is used to query all staking transactions based on the provided parameter `status` and `address`"
---
