    ...
    <Expandable title="Answer">
        <ResponseField >
         The withdraw fees may fluctuate based on how busy a blockchain network is. You can refer to the `abs_estimate_fee` field
          of the [GET /v1/custody/coin_info](/api-references/custody-wallet/coin_info) endpoint to check the estimated withdraw fees associated with a Custodial Wallet.
