...
Call [Get withdrawable balances](/v2/api-references/payment/get-withdrawable-balances) to query specified merchant balance or developer balance and determine the maximum amount you can settle. In order mode, you need to set the `acquiring_type` field to `Order`.
