...
The Cobo payments solution currently supports **USDC** and **USDT**, and can be used on multiple mainstream chains. This document details the support for various token and chain combinations for payment collection and fiat off-ramp scenarios.
...
The following table lists the fiat off-ramp support for various token and chain combinations across different environments:
...
<Info>Token and chain combinations marked as "bridging fee required" incur additional bridging fees on top of regular fees when performing fiat off-ramp operations.</Info>
