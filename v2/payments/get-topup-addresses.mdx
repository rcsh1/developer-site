...
- **Fund handling**: New deposited funds at the old address will still be allocated to merchant balance and developer balance according to the original developer fee rate.
