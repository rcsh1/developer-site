...
<table class="table-three-cols">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>(Optional) The app's default approval workflows. For how to configure approval workflows, refer to <a href="/v2/apps/configure-workflow">Configure approval workflows</a>.</td>
