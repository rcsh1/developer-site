...
<Note>To fully use the approval workflow, your app must send `operation_id` to the WaaS 2.0 service. Please contact [help@cobo.com](mailto:help@cobo.com.).</Note>
