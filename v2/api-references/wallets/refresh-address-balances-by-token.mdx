...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    refresh_address_balances_by_token_request = (
        cobo_waas2.RefreshAddressBalancesByTokenRequest(addresses=["3HYV6ta67197syD1ZVFganpmL2wLz4RyoC"])
    )
...
public class Example {
  public static void main(String[] args) {
    ...
    RefreshAddressBalancesByTokenRequest refreshAddressBalancesByTokenRequest =
        new RefreshAddressBalancesByTokenRequest().addresses(Arrays.asList("3HYV6ta67197syD1ZVFganpmL2wLz4RyoC"));
    try {
...
const opts = {
  RefreshAddressBalancesByTokenRequest:
    new CoboWaas2.RefreshAddressBalancesByTokenRequest({
