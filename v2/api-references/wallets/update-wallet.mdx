...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    update_wallet_params = cobo_waas2.UpdateWalletParams(
        cobo_waas2.UpdateCustodialWalletParams(
            wallet_type="Custodial", name="My WaaS 2.0 Wallet"
        )
    )
...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateWalletParams updateWalletParams =
        new UpdateWalletParams(
            new UpdateCustodialWalletParams()
...
func main() {
	...
	updateWalletParams := coboWaas2.UpdateWalletParams{
		UpdateCustodialWalletParams: coboWaas2.NewUpdateCustodialWalletParams(
...
const opts = {
  UpdateWalletParams: new CoboWaas2.UpdateWalletParams.constructFromObject({
