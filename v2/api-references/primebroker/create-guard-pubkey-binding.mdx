---
openapi: post /prime_broker/user/{user_id}/guard_pubkey
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.change_guard_pubkey200_response import (
...
apiInstance.createGuardPubkey(user_id).then(
  (data) => {
