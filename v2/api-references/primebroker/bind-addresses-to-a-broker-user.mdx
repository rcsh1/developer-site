...
```python Python
import cobo_waas2
from cobo_waas2.models.create_prime_broker_address201_response import (
    CreatePrimeBrokerAddress201Response,
)
from cobo_waas2.models.create_prime_broker_address_request import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print(
            "Exception when calling PrimeBrokerApi->create_prime_broker_address: %s\n"
            % e
        )
...
public class Example {
  public static void main(String[] args) {
    ...
    CreatePrimeBrokerAddressRequest createPrimeBrokerAddressRequest =
        new CreatePrimeBrokerAddressRequest();
    try {
      CreatePrimeBrokerAddress201Response result =
          apiInstance.createPrimeBrokerAddress(userId, createPrimeBrokerAddressRequest);
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PrimeBrokerAPI.CreatePrimeBrokerAddress``: %v\n",
			err,
		)
...
const opts = {
  CreatePrimeBrokerAddressRequest:
    new CoboWaas2.CreatePrimeBrokerAddressRequest(),
};
