...
|---------------------|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| 1000                | Internal Server Error. This error can be caused by several issues including expired [Org Access Tokens](https://www.cobo.com/developers/v2/apps/org-access-tokens). | Check your server configuration settings, including whether your Org Access Token has expired, and try again later.   |
...
| 12002          | The specified token is not supported by Cobo.                                                     | Choose a supported token. Call the [List supported tokens](https://www.cobo.com/developers/v2/api-references/wallets/list-supported-tokens) operation to get the full list of supported tokens.          |
...
| 2023                | Missing or invalid API signature.                                                                                      | Verify your API signature and ensure it is correct. You can refer to [Calculate the API signature](https://www.cobo.com/developers/v2/guides/overview/cobo-auth#calculate-the-api-signature) for details.                                                                                   |
...
| 2025, 4001                | Forbidden access to the requested resource.                                                             | Check the permissions associated with your API key. You can refer to [Permissions and wallet scopes](https://www.cobo.com/developers/v2/guides/overview/permissions-and-scopes) for details.                                                                               |
...
| 500             | Internal Server Error. This error can be caused by several issues including expired [Org Access Tokens](https://www.cobo.com/developers/v2/apps/org-access-tokens). | Check your server configuration settings, including whether your Org Access Token has expired, and try again later.                              |
