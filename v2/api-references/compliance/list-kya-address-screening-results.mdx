---
openapi: get /compliance/kya/screenings
---
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListKyaScreenings200Response result =
          apiInstance.listKyaScreenings(screeningIds, limit, before, after);
...
func main() {
	...
	resp, r, err := apiClient.ComplianceAPI.ListKyaScreenings(ctx).
...
apiInstance.listKyaScreenings(opts).then(
  (data) => {
