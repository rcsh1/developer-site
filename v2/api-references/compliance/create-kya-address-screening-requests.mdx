---
openapi: post /compliance/kya/screenings
---
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateKyaScreeningsBody createKyaScreeningsBody =
        new CreateKyaScreeningsBody()
            .screenings(
                Arrays.asList(
                    new KyaScreeningRequest()
                        .requestId("scan_eth_addr1_20240721")
                        .address("0x1234567890abcdef1234567890abcdef12345678")
                        .chainId("ETH")));
    try {
...
func main() {
	...
	resp, r, err := apiClient.ComplianceAPI.CreateKyaScreenings(ctx).
		CreateKyaScreeningsBody(createKyaScreeningsBody).
		Execute()
	if err != nil {
...
const opts = {
  CreateKyaScreeningsBody:
    CoboWaas2.CreateKyaScreeningsBody.constructFromObject({
      screenings: [
        {
          request_id: "scan_eth_addr1_20240721",
          address: "0x1234567890abcdef1234567890abcdef12345678",
...
apiInstance.createKyaScreenings(opts).then(
  (data) => {
