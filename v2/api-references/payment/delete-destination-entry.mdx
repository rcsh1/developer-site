...
```python Python
import cobo_waas2
from cobo_waas2.models.delete_destination_entry200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.delete_destination_entry(
            destination_entry_id, destination_id, entry_type
        )
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DeleteDestinationEntry200Response result =
          apiInstance.deleteDestinationEntry(destinationEntryId, destinationId, entryType);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.DeleteDestinationEntry(ctx, destinationEntryId).
