...
```python Python
import cobo_waas2
from cobo_waas2.models.create_counterparty_entry201_response import (
    CreateCounterpartyEntry201Response,
)
from cobo_waas2.models.create_counterparty_entry_request import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.create_counterparty_entry(
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateCounterpartyEntryRequest createCounterpartyEntryRequest =
        new CreateCounterpartyEntryRequest()
            .counterpartyId(UUID.fromString("123e4567-e89b-12d3-a456-426614174003"));
    try {
      CreateCounterpartyEntry201Response result =
          apiInstance.createCounterpartyEntry(createCounterpartyEntryRequest);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.CreateCounterpartyEntry(ctx).
		CreateCounterpartyEntryRequest(createCounterpartyEntryRequest).
		Execute()
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PaymentAPI.CreateCounterpartyEntry``: %v\n",
			err,
		)
...
const opts = {
  CreateCounterpartyEntryRequest:
    CoboWaas2.CreateCounterpartyEntryRequest.constructFromObject({
      counterparty_id: "123e4567-e89b-12d3-a456-426614174003",
    }),
};
apiInstance.createCounterpartyEntry(opts).then(
  (data) => {
