...
from cobo_waas2.models.list_destination_entries200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.list_destination_entries(
            entry_type,
            limit=limit,
            before=before,
            after=after,
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListDestinationEntries200Response result =
          apiInstance.listDestinationEntries(
              entryType,
              limit,
              before,
              after,
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.ListDestinationEntries(ctx).
		EntryType(entryType).
		Limit(limit).
		Before(before).
		After(after).
...
apiInstance.listDestinationEntries(entry_type, opts).then(
  (data) => {
