...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    create_settlement_request_request = cobo_waas2.CreateSettlementRequestRequest(
        request_id="SETTLEMENT123", settlements=[cobo_waas2.CreateSettlement(
                    amount="500.00",
                    bank_account_id="123e457-e89b-12d3-a456-426614174004",
                )]
    )
    ...
    CreateSettlementRequestRequest createSettlementRequestRequest =
        new CreateSettlementRequestRequest()
            ...
            .settlements(Arrays.asList(
              ...
              .amount("500.00")
              .bankAccountId(UUID.fromString("123e457-e89b-12d3-a456-426614174004"))
            ));
    try {
...
func main() {
	createSettlementRequestRequest := *coboWaas2.NewCreateSettlementRequestRequest("SETTLEMENT123", []coboWaas2.CreateSettlement{*coboWaas2.NewCreateSettlement("500.00", "0123e457-e89b-12d3-a456-426614174004")})
