---
openapi: put /payments/merchants/{merchant_id}
---
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        # Update merchant
        api_response = api_instance.update_merchant_by_id(
            merchant_id, update_merchant_by_id_request=update_merchant_by_id_request
        )
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.UpdateMerchantById(ctx, merchantId).
...
apiInstance.updateMerchantById(merchant_id, opts).then(
  (data) => {
