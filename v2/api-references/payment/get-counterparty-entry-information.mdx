...
from cobo_waas2.models.get_counterparty_entry200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.get_counterparty_entry(
            counterparty_entry_id, entry_type=entry_type
        )
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetCounterpartyEntry200Response result =
          apiInstance.getCounterpartyEntry(counterpartyEntryId, entryType);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.GetCounterpartyEntry(ctx, counterpartyEntryId).
		EntryType(entryType).
		Execute()
	if err != nil {
...
apiInstance.getCounterpartyEntry(counterparty_entry_id, opts).then(
  (data) => {
