...
func main() {
	createRefundRequest := *coboWaas2.NewCreateRefundRequest("123e4567-e89b-12d3-a456-426614174004", "0.25", "0x9876543210abcdef1234567890abcdef12345678", "ETH_USDT", coboWaas2.RefundType("Merchant"))
