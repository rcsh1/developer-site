...
```python Python
import cobo_waas2
from cobo_waas2.models.list_batch_allocations200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.list_batch_allocations(
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListBatchAllocations200Response result =
          apiInstance.listBatchAllocations(limit, before, after, requestId);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.ListBatchAllocations(ctx).
		Limit(limit).
		Before(before).
		After(after).
		RequestId(requestId).
...
apiInstance.listBatchAllocations(opts).then(
  (data) => {
