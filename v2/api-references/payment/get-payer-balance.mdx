  ...
  public static void main(String[] args) {
    ...
    try {
      List<ReceivedAmountPerAddress> result =
          apiInstance.getPayerBalanceByAddress(merchantId, payerId, tokenId);
...
apiInstance.getPayerBalanceByAddress(merchant_id, payer_id, token_id).then(
  (data) => {
