        ...
        new CreateOrderLinkRequest()
            .businessInfo(
                new OrderLinkBusinessInfo()
                    .tokenIds(Arrays.asList("ETH_USDT", "SOL_USDC", "TRON_USDT"))
                    .currency("USD")
                    .feeAmount("2.00")
                    .merchantId("1001")
                    .orderAmount("100.00")
...
func main() {
	createOrderLinkRequest := *coboWaas2.NewCreateOrderLinkRequest(*coboWaas2.NewOrderLinkBusinessInfo([]string{"ETH_USDT"}, "USD", "2.00", "1001", "100.00", "P20240201001"))
