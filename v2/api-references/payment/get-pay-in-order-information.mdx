---
openapi: get /payments/orders/{order_id}
---
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print(
            "Exception when calling PaymentApi->get_payment_order_detail_by_id: %s\n"
            % e
        )
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PaymentAPI.GetPaymentOrderDetailById``: %v\n",
			err,
		)
...
apiInstance.getPaymentOrderDetailById(order_id).then(
  (data) => {
