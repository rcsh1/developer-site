---
openapi: get /payments/exchange_rates
---
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.BatchGetExchangeRates(ctx).
		TokenIds(tokenIds).
...
apiInstance.batchGetExchangeRates(token_ids, currencies).then(
  (data) => {
