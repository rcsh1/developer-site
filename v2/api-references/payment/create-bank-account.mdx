---
openapi: post /payments/bank_accounts
---
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        # Create bank account
        api_response = api_instance.create_bank_account(
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.CreateBankAccount(ctx).
...
apiInstance.createBankAccount(opts).then(
  (data) => {
