...
from cobo_waas2.models.update_destination_by_id_request import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    update_destination_by_id_request = cobo_waas2.UpdateDestinationByIdRequest(
        destination_name="Destination A", destination_type="Individual"
    )

    try:
        # Update destination
        api_response = api_instance.update_destination_by_id(
            destination_id,
...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateDestinationByIdRequest updateDestinationByIdRequest =
        new UpdateDestinationByIdRequest()
            .destinationName("Destination A")
            .destinationType(DestinationType.INDIVIDUAL);
    try {
      Destination result =
          apiInstance.updateDestinationById(destinationId, updateDestinationByIdRequest);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.UpdateDestinationById(ctx, destinationId).
		UpdateDestinationByIdRequest(updateDestinationByIdRequest).
		Execute()
	if err != nil {
...
const opts = {
  UpdateDestinationByIdRequest:
    CoboWaas2.UpdateDestinationByIdRequest.constructFromObject({
      destination_name: "Destination A",
      destination_type: "Individual",
    }),
};
apiInstance.updateDestinationById(destination_id, opts).then(
  (data) => {
