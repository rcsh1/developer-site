...
from cobo_waas2.models.update_counterparty_by_id_request import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    update_counterparty_by_id_request = cobo_waas2.UpdateCounterpartyByIdRequest(
        counterparty_name="Counterparty A", counterparty_type="Individual"
    )
...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateCounterpartyByIdRequest updateCounterpartyByIdRequest =
        new UpdateCounterpartyByIdRequest()
            .counterpartyName("Counterparty A")
            .counterpartyType(CounterpartyType.INDIVIDUAL);
    try {
      Counterparty result =
          apiInstance.updateCounterpartyById(counterpartyId, updateCounterpartyByIdRequest);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.UpdateCounterpartyById(ctx, counterpartyId).
		UpdateCounterpartyByIdRequest(updateCounterpartyByIdRequest).
		Execute()
	if err != nil {
...
const opts = {
  UpdateCounterpartyByIdRequest:
    CoboWaas2.UpdateCounterpartyByIdRequest.constructFromObject({
      counterparty_name: "Counterparty A",
      counterparty_type: "Individual",
    }),
};
apiInstance.updateCounterpartyById(counterparty_id, opts).then(
  (data) => {
