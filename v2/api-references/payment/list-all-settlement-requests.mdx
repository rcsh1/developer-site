---
openapi: get /payments/settlement_requests
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.list_settlement_requests200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.list_settlement_requests(
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListSettlementRequests200Response result =
          apiInstance.listSettlementRequests(limit, before, after, requestId);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.ListSettlementRequests(ctx).
		Limit(limit).
		Before(before).
		After(after).
		RequestId(requestId).
...
apiInstance.listSettlementRequests(opts).then(
  (data) => {
