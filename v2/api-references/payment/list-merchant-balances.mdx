  ...
  public static void main(String[] args) {
    ...
    try {
      ListMerchantBalances200Response result =
          apiInstance.listMerchantBalances(tokenId, acquiringType, merchantIds);
...
const acquiring_type = "Order";
const opts = {
  merchant_ids: "M1001,M1002,M1003",
};
apiInstance.listMerchantBalances(token_id, acquiring_type, opts).then(
  (data) => {
