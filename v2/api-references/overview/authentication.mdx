...
This article introduces the authentication methods required for using the WaaS service.

To ensure secure access to your crypto assets via APIs, the WaaS service validates the use of EDDSA signatures for authentication in all API calls. Access to the API is denied without proper authentication. You need to provide an API key, a nonce, and an API signature in the request header as follows. 
...
3. Generate an Ed25519 key pair
    ...
    You can use either OpenSSL or the Python library to generate an Ed25519 key pair.
    ...
    - Using the Python library
        ...
        2. Generate a key pair
            ...
            Use the Python library to generate a key pair as follows:
