...
<table class="table-three-cols">
  ...
  <tbody>
    <tr>
      ...
      <td rowspan="11"><code>Transaction</code></td>
    ...
    <tr>
      ...
      <td>A Fee Station transaction has been successfully completed.</td>
        ...
        <tr>
      <td><code>payment.transaction.created</code></td>
      <td>A new payment transaction has been created.</td>
    </tr>
    <tr>
      <td><code>payment.transaction.late</code></td>
      <td>A payment transaction is overdue and has not been completed within the expected time.</td>
    </tr>
    <tr>
      <td><code>payment.transaction.held</code></td>
      <td>A payment transaction has been held due to review or processing issues.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>The status of a payment order has changed.</td>
    </tr>
    <tr>
      <td><code>payment.refund.status.updated</code></td>
      <td><code>PaymentRefund</code></td>
      <td>The status of a refund request has changed.</td>
    </tr>
    <tr>
      <td><code>payment.settlement.status.updated</code></td>
      <td><code>PaymentSettlement</code></td>
      <td>The status of a settlement has changed.</td>
    </tr>
  </tbody>
</table>
