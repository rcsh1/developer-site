...
- Ethereum Mainnet (ETH, ERC-20 tokens).  
  Batch transfer smart contract address: [`0x3d963e23a9229D2ACd25E9FFC358be1a35460ecc`](https://etherscan.io/address/0x3d963e23a9229D2ACd25E9FFC358be1a35460ecc#code)
...
The following steps apply to batch transfers of ETH (native coin) on Ethereum Mainnet:
...
The following steps apply to batch transfers of ERC-20 tokens on Ethereum Mainnet:
