...
|----------------------------------------------------|-------------------------------------------------------------------------------------------------|--------------------------|
| Deposit - [Loop](https://loop.top/) transfers       | DepositFromLoop                                                                                | DepositToAddress         |
...
- `DepositFromLoop`: A transfer sent through the [Loop](https://loop.top/) transfer network. 
