...
The table below provides a complete overview of all transaction statuses and their corresponding sub-statuses in the WaaS 2.0 service.
...
<table className="table-three-cols">
  ...
  <tr>
    <td rowspan="3">PendingScreening</td>
  ...
  <tr>
    ...
    <td>The transaction is rejected because it failed the screening check by the [Screening app](https://manuals.cobo.com/en/apps/screening/introduction).</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>The transaction is rejected due to it failed the transaction policies.</td>
  </tr>
  <tr>
