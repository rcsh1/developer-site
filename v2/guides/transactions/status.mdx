...
<tr><td>Submitted</td><td>N/A</td><td>The transaction is submitted.</td></tr>


<tr><td rowspan="4">PendingScreening</td><td>PendingTravelRuleCheck</td><td>Undergoing Travel Rule check.</td></tr>
<tr><td>PendingTravelRuleInfo</td><td>Waiting for Travel Rule information.</td></tr>
<tr><td>PendingScreeningAppCheck</td><td>Under review by the Screening app.</td></tr>
<tr><td>PendingCoboKYTCheck</td><td>Pending Cobo's KYT check.</td></tr>


<tr><td rowspan="5">PendingAuthorization</td><td>PendingDoubleCheck</td><td>Pending a double check.</td></tr>
<tr><td>PendingSpenderCheck</td><td>Pending spender check.</td></tr>
<tr><td>PendingRiskControlCheck</td><td>Pending risk control check.</td></tr>
<tr><td>PendingApproverCheck</td><td>Pending approver approval.</td></tr>
<tr><td>PendingCoboCheck</td><td>Pending internal check by Cobo.</td></tr>


<tr><td rowspan="11">PendingSignature</td><td>Queue</td><td>Queued for processing.</td></tr>
<tr><td>PendingWaitSigner</td><td>Waiting for signature.</td></tr>
<tr><td>InsufficientBalance</td><td>Cannot proceed due to insufficient balance.</td></tr>
<tr><td>InsufficientBalanceFundLocked</td><td>Cannot proceed because balance is locked.</td></tr>
<tr><td>PendingSystemProcessing</td><td>Awaiting blockchain system processing.</td></tr>
<tr><td>SystemProcessingOngoing</td><td>System is processing the transaction.</td></tr>
<tr><td>Built</td><td>Built but not signed yet.</td></tr>
<tr><td>PendingSignerApproval</td><td>Pending approval from signer.</td></tr>
<tr><td>PendingApprovalStart</td><td>Approval process has not started.</td></tr>
<tr><td>PendingSignerProcessing</td><td>Transaction is being signed.</td></tr>
<tr><td>SignatureVerificationSuccess</td><td>Signature verified successfully.</td></tr>


<tr><td>Broadcasting</td><td>FailedBroadcasting</td><td>Failed to broadcast to blockchain.</td></tr>


<tr><td rowspan="2">Confirming</td><td>Reverting</td><td>Transaction is reverting due to failure.</td></tr>
<tr><td>PendingBlockConfirmations</td><td>Awaiting required confirmations.</td></tr>


<tr><td>Completed</td><td>N/A</td><td>Transaction completed.</td></tr>


<tr><td rowspan="6">Failed</td><td>FailedBySigner</td><td>Failed during signing.</td></tr>
<tr><td>FailedOnChain</td><td>Failed on blockchain.</td></tr>
<tr><td>ReplacedByNewTransaction</td><td>Replaced by a new transaction.</td></tr>
<tr><td>SignatureVerificationFailed</td><td>Signature verification failed.</td></tr>
<tr><td>FailedSignerTimeout</td><td>Failed due to signature timeout.</td></tr>
<tr><td>ReOrged</td><td>Failed due to blockchain reorganization.</td></tr>


<tr><td rowspan="18">Rejected</td><td>RejectedWhiteList</td><td>Initiator IP not whitelisted.</td></tr>
<tr><td>RejectedKYT</td><td>KYT compliance failed.</td></tr>
<tr><td>RejectedRiskControlCheck</td><td>Risk control check failed.</td></tr>
<tr><td>RejectedSpenderAuth</td><td>Rejected by spender.</td></tr>
<tr><td>RejectedApproverAuth</td><td>Rejected by approver.</td></tr>
<tr><td>RejectedDoubleCheck</td><td>Double check failed.</td></tr>
<tr><td>RejectedbyMobileCosigner</td><td>Rejected by mobile cosigner.</td></tr>
<tr><td>RejectedCoboCheck</td><td>Failed internal check by Cobo.</td></tr>
<tr><td>RejectedByScreeningApp</td><td>Failed Screening app check.</td></tr>
<tr><td>RejectedTravelRuleDueToUnsupportedToken</td><td>Token not supported by Travel Rule.</td></tr>
<tr><td>RejectedTravelRule</td><td>Failed Travel Rule compliance.</td></tr>
<tr><td>RejectedTravelRuleDueToCompliance</td><td>Cross-check failed Travel Rule.</td></tr>
<tr><td>RejectedTransactionPolicy</td><td>Transaction policy violation.</td></tr>
<tr><td>RejectedBySigner</td><td>Rejected by signer.</td></tr>
<tr><td>CanceledBySpender</td><td>Canceled by spender.</td></tr>
<tr><td>CanceledByAPI</td><td>Canceled via API.</td></tr>
<tr><td>OnchainRejection</td><td>Rejected by blockchain.</td></tr>
<tr><td>RejectedByCobo</td><td>Rejected by Cobo (contact support).</td></tr>
</table>
