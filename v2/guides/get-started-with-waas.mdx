...
Note: You can skip this step if you choose to [use a WaaS SDK](/v2/developer-tools/quickstart-python), which encapsulates the authentication mechanism.
...
Note: You can skip this step if you choose to [use a WaaS SDK](/v2/developer-tools/quickstart-python), which offers ready-to-use functions that handle the API integration using the programming language of your project.
