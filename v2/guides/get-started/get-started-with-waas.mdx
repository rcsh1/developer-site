---
title: "Get started with Wallet-as-a-Service (WaaS) 2.0"
...
8. Select **Temporary** as the key type. <Note>If you already have a static IP address, you can select **Permanent** as the key type instead and enter your IP address in the textbox.</Note>
9. Click **Register**.
