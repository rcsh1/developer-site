...
- Added new OAuth operations for secure SDK authentication:
...
### Improvements
- Enhanced [Transfer token](/v2/api-references/transactions/transfer-token) operation to support Custodial Wallet (Asset Wallet) transfers using a wallet ID.
