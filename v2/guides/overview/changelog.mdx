...
- You can now stake your tokens with the WaaS 2.0 API. Staking operations include:
  - [List staking positions](/v2/api-references/stakings/list-all-stakings)
  - [Get staking position details](/v2/api-references/stakings/get-staking-by-id)
  - [List staking activities](/v2/api-references/stakings/list-staking-activities)
  - [Estimate staking fees](/v2/api-references/stakings/estimate-staking-transaction-fee)
  - [Create stake activity](/v2/api-references/stakings/create-staking-activity)
...
- Changed the path of the [Check loop transfers](/v2/api-references/transactions/check-loop-transfers) operation from `/wallets/check_loop_transfers` to `/transactions/check_loop_transfers`.
...
- Added the following operations for batch payment:
  ...
  - [Check Loop transfers](/v2/api-references/wallets/check-loop-transfers)
