...
- Added the following operations for tracking transaction approvals and retrieving approval templates:
  - [List transaction approvals](/v2/api-references/transactions/list-transaction-approvals)
  - [List approval templates](/v2/api-references/transactions/list-approval-templates)
