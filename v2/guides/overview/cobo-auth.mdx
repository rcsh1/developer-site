...
This section introduces three ways to generate an API key and an API secret using the Ed25519 algorithm. You can also generate app keys using other tools that use the Ed25519 algorithm.
...
3. Use the API secret to sign the string as follows:
    ...
    # Create a signing key. Replace `api_secret` with your API secret.
