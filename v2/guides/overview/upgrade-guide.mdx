...
With the WaaS 2.0 API, you not only can integrate Cobo’s powerful wallet capabilities directly into your applications, but also build [Cobo Portal Apps](https://manuals.cobo.com/en/portal/portal-apps/introduction) to significantly expand the capabilities of Cobo Portal, whether for all Cobo Portal users or specifically for your own use.

For a complete introduction to WaaS 2.0, see [Introduction to WaaS 2.0](https://www.cobo.com/developers/v2/guides/overview/introduction).
...
Follow the instructions in [Get started with WaaS 2.0](https://www.cobo.com/developers/v2/guides/get-started-with-waas) to set up your account, create and register your API key, integrate a WaaS SDK if necessary, and send your first API request to the WaaS 2.0 service.
...
|                            | WaaS 1.0                                                     | WaaS 2.0                                                     |
| -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Create a wallet            | Not supported since the API key is wallet-specific           | [Create wallet](https://www.cobo.com/developers/v2/api-references/wallets/create-wallet) |
| Create an address          |  <ul><li>**[Custodial Wallets]** [Get New Deposit Address](https://www.cobo.com/developers/v1/api-references/custody-wallet/new_address)</li><li>**[MPC Wallets]** [Generate Addresses](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_generate_addresses) and [Generate Address Memos](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_generate_address_memo)</li></ul> | [Create addresses in wallet](https://www.cobo.com/developers/v2/api-references/wallets/create-addresses-in-wallet) |
| Withdraw tokens            | <ul><li>**[Custodial Wallets]** [New withdraw request](https://www.cobo.com/developers/v1/api-references/custody-wallet/new_withdraw_request)</li><li>**[MPC Wallets]** [Create Transaction](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_create_transaction)</li></ul> | [Transfer token](https://www.cobo.com/developers/v2/api-references/transactions/transfer-token) |
| RBF transaction (Speed up) | **[MPC Wallets]** [Speedup Transaction](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_speedup_transaction) | [Speed up transaction](https://www.cobo.com/developers/v2/api-references/transactions/speed-up-transaction) |
| RBF transaction (Drop)     | **[MPC Wallets]** [Drop Transaction](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_drop_transaction) | [Drop transaction](https://www.cobo.com/developers/v2/api-references/transactions/drop-transaction) |
| RBF transaction (Resend)   | Not supported                                                | [Resend transaction](https://www.cobo.com/developers/v2/api-references/transactions/resend-transaction) |
| RBF transaction (Cancel)   | Not supported                                                | [Cancel transaction](https://www.cobo.com/developers/v2/api-references/transactions/cancel-transaction) |
| Call a contract            | Not supported                                                | [Call smart contract](https://www.cobo.com/developers/v2/api-references/transactions/call-smart-contract) |
| Sign a message             | Not supported                                                | [Sign message](https://www.cobo.com/developers/v2/api-references/transactions/sign-message) |
| Query a transaction        | <ul><li>**[Custodial Wallets]** [Transaction history](https://www.cobo.com/developers/v1/api-references/custody-wallet/transaction_history)</li><li>**[MPC Wallets]** [Get Transactions List](https://www.cobo.com/developers/v1/api-references/mpc-wallet/mpc_list_transactions)</li></ul> | <ul><li>[List all transactions](https://www.cobo.com/developers/v2/api-references/transactions/list-all-transactions)</li><li>[Get transaction information](https://www.cobo.com/developers/v2/api-references/transactions/get-transaction-information)</li></ul>|