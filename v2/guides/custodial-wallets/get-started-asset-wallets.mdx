...
sidebarTitle: "Custodial Wallets (Asset Wallets)"
lang: "en"
description: "Learn to use Custodial Wallets with WaaS 2.0 API, such as querying chains, creating wallets, depositing, withdrawing, and more."
---
