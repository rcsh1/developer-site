...
<AccordionGroup>
  ...
  <Accordion title="TSS Request">
    #### Attributes:
    - `cobo_tss_request_id`: Unique identifier for the [TSS request](/v2/api-references/wallets--mpc-wallets/create-tss-request).
  ...
  <Accordion title="Group">
    #### Attributes:
    - `cobo_key_share_holder_group_id`: Unique identifier for the [key share holder group](/v2/guides/mpc-wallets/get-started-ocw#create-a-key-share-holder-group).
...
- If you choose to use a WaaS SDK instead of manually writing the API requests, refer to the SDK guide corresponding to the programming language of your choice ([Python](/v2/developer-tools/quickstart-python), [Java](https://github.com/CoboGlobal/cobo-waas2-java-sdk), [Go](/v2/developer-tools/quickstart-go), [JavaScript](https://github.com/CoboGlobal/cobo-waas2-js-sdk)) to integrate the SDK into your Client Backend.
- Prepare some test tokens as you will need them when testing the deposit feature. To know which test tokens you can use, refer to [Query chain and token information](https://www.cobo.com/developers/v2/guides/mpc-wallets/get-started-ocw#1-query-chain-and-token-information). In most cases, you can use XTN as the test token.
...
<Steps>
  <Step title="Create projects with the Client Backend or Cobo Portal.">
    ...
    - To create projects with the Client Backend, call the [Create project](/v2/api-references/wallets--mpc-wallets/create-project) operation.
  ...
  <Step title="Initialize UCW SDK">
    ...
    - **Initialize UCW SDK**
        ...
        - Client App → UCW SDK
            ...
            1. Client App sends a request to initialize the UCW SDK by calling the [Initialize Secrets](/v2/developer-tools/ucw-sdk/initialize-secrets/initialize-secrets) operation.
  ...
  <Step title="Create a vault">
    ...
    - **Create the vault in Cobo Backend**
        ...
        - Client Backend → Cobo Backend
            ...
            2. Client Backend forwards the request to the Cobo Backend to create a new vault for the specified project by calling the [Create vault](/v2/api-references/wallets--mpc-wallets/create-vault) operation.
  ...
  <Step title="Create a Main Group">
    ...
    - **Open UCW SDK in the Client App**
        ...
        - Client App → UCW SDK
            ...
            1. Client App opens a UCW SDK instance by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) and [Create UCWPublic class](/v2/developer-tools/ucw-sdk/ucwpublic-class/create-ucw-public) operations.
    ...
    - **Retrieve TSS Node ID**
        ...
        - Client App → UCW SDK
            ...
            3. Client App calls the [Get TSS Node ID](/v2/developer-tools/ucw-sdk/ucwpublic-class/get-tss-node-id) operation on the UCWSDKPublic to retrieve the TSS Node ID.
    ...
    - **Initialize Main Group creation**
        ...
        - Client Backend → Cobo Backend
            ...
            6. Client Backend calls the [Create key share holder group](/v2/api-references/wallets--mpc-wallets/create-key-share-holder-group) operation, instructing the Cobo Backend to create a Main Group.
    ...
    - **Initialize key generation request**
        ...
        - Client Backend → Cobo Backend
            ...
            10. Client Backend calls the [Create TSS request](/v2/api-references/wallets--mpc-wallets/create-tss-request) operation, instructing the Cobo Backend to initiate the key generation process.
            ...
            You can optionally monitor the status of the TSS request on the Client Backend through either webhook or polling.
                ...
                - **Webhook option**
                    ...
                    16. Cobo Backend sends a webhook to the Client Backend with the current status of the TSS request.
                        ...
                        <Info>To see the available webhook event types, see [Webhook event types](/v2/guides/webhooks-callbacks/webhook-event-type#webhook-event-types).</Info>

                        <Info>To see how to set up your Client Backend to receive webhook events, see [Set up a callback or webhook endpoint](/v2/guides/webhooks-callbacks/set-up-endpoint).</Info>

                - **Polling option**

                    17. Client Backend polls the Cobo Backend to retrieve the status of the TSS request by calling the [Get TSS request](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
    ...
    - **Review and approval of TSS request in Client App**
        ...
        - Client App → UCW SDK
            ...
            22. Client App calls the UCW SDK to get the pending TSS requests by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
        ...
        - Client App → UCW SDK
            ...
            27. User uses the Client App to approve the TSS request. The Client App calls the [Approve TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/approve-tss-requests) operation and passes in the TSS request ID.
        ...
        - Client App → UCW SDK
            ...
            30. Client App checks the status of the TSS request with the UCW SDK by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
    ...
    - **(Optional) Monitor key generation result on Client Backend**
        - Cobo Backend → Client Backend
            ...
            - **Polling Option**
                ...
                35. Client Backend polls the Cobo Backend for the key generation result by calling the [Get TSS request](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
    ...
    #### Sequence of operations
        ...
        - **Create a wallet**
          ...
          - Client Backend → Cobo Backend
            ...
            2. Client Backend forwards the request to the Cobo Backend by calling the [Create wallet](/v2/api-references/wallets/create-wallet) operation and passing in the necessary vault ID and wallet name to create the wallet.
        ...
        - **Generate an address**
          ...
          - Client Backend → Cobo Backend
            ...
            7. Client Backend forwards the request to the Cobo Backend by calling the [Create addresses in wallet](/v2/api-references/wallets/create-addresses-in-wallet) operation, specifying the wallet ID, the chain ID, and the number of addresses to create (count).
    ...
    #### Sequence of operations
        ...
        - **Estimate transaction fee**
          ...
          - Client Backend → Cobo Backend
            ...
            2. Client Backend forwards the request to the Cobo Backend to estimate the fee for the transaction by calling the [Estimate transaction fee](/v2/api-references/transactions/estimate-transaction-fee) operation.
        ...
        - **Submit transaction**
          ...
          - Client Backend → Cobo Backend
            ...
            7. Client Backend forwards the transaction data to the Cobo Backend to initiate the transaction by calling the [Transfer token](/v2/api-references/transactions/transfer-token) operation.
        ...
        - **Monitor transaction status on Client Backend**
          - Cobo Backend → Client Backend
            ...
            - **Polling option**
              ...
              Client Backend polls the Cobo Backend to get updates on the transaction status by calling the [Get transaction information](/v2/api-references/transactions/get-transaction-information) operation.
        ...
        - **Review and approve the transaction**
          ...
          - Client App → UCW SDK
            ...
            17. Client App calls the UCW SDK to retrieve detailed transaction information by calling the [Get transactions](/v2/developer-tools/ucw-sdk/ucw-class/get-transactions) operation.
          ...
          - Client App → UCW SDK
            ...
            22. Client App approves the transaction using the UCW SDK by calling the [Approve transactions](/v2/developer-tools/ucw-sdk/ucw-class/approve-transactions) operation, initiating the signing process.
        ...
        - **Update transaction status**
          ...
          - Client App → UCW SDK
            ...
            25. Client App checks the status of the transaction via the UCW SDK by calling the [Get transactions](/v2/developer-tools/ucw-sdk/ucw-class/get-transactions) operation.
        ...
        - **Finalize the transaction**
          ...
          - Cobo Backend → Client Backend
            ...
            - **Polling option**
              ...
              Client Backend polls the Cobo Backend for the final transaction information by calling the [Get transaction information](/v2/api-references/transactions/get-transaction-information) operation.
    ...
    #### Sequence of operations
        ...
        - **Open UCW SDK 1 in Client App 1**
          ...
          - Client App 1 → UCW SDK 1
            ...
            1. Client App 1 opens an instance of the UCW SDK 1 by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) operation.
        ...
        - **Export Secrets**
          ...
          - Client App 1 → UCW SDK 1
            ...
            3. Client App 1 calls the [Export Secrets](/v2/developer-tools/ucw-sdk/ucw-class/export-secrets) operation on the UCW SDK 1 instance, providing a passphrase for encryption.
        ...
        - **Import Secrets into UCW SDK 2**
          ...
          - Client App 2 → UCW SDK 2
            ...
            7. Client App 2 calls the [Import Secrets](/v2/developer-tools/ucw-sdk/other-apis/import-secrets) operation and provides the passphrase and the encrypted Secrets, which allows UCW SDK 2 to import the Secrets.
    ...
    #### Sequence of operations
        ...
        - **Initialize UCW SDKs 2 and 3 in Client Apps 2 and 3**
          ...
          - Client Apps 2, 3 → UCW SDK 2, 3
            ...
            1. Client Apps 2 and 3 initiate their respective UCW SDKs 2 and 3 instances by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) operation.
          ...
          - Client Apps 2, 3 → UCW SDK 2, 3
            ...
            3. Client Apps 2 and 3 obtain the TSS Node IDs by calling the [Get TSS Node ID](/v2/developer-tools/ucw-sdk/ucwpublic-class/get-tss-node-id) operation.
        ...
        - **Create Recovery Group**
          ...
          - Client Backend → Cobo Backend
            ...
            7. Client Backend forwards the request to the Cobo Backend by calling the [Create key share holder group](/v2/api-references/wallets--mpc-wallets/create-key-share-holder-group) operation, specifying the Recovery Group details and key share holders.
          - Cobo Backend → Client Backend
        ...
        - **Initialize key generation request**
          ...
          - Client Backend → Cobo Backend
            ...
            9. Client Backend submits a request to the Cobo Backend to use the Main Group to create key shares for your Recovery Group by calling the [Create TSS request](/v2/api-references/wallets--mpc-wallets/create-tss-request) operation and specifying `KenGenFromKeyGroup` as the `type`.
        ...
        - **Monitor TSS request status on Client Backend**
          ...
          - Cobo Backend → Client Backend
            ...
            - **Polling option**
              ...
              The Client Backend polls the Cobo Backend for the status of the TSS request by calling the [Get TSS request](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
        ...
        - **Review and approve TSS requests in Client Apps**
          ...
          - Client App 1 → UCW SDK 1
            ...
            21. Client App 1 retrieves the pending TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
          ...
          - Client App 1 → UCW SDK 1
            ...
            24. After review, Client App 1 approves the TSS request by calling the [Approve TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/approve-tss-requests) operation.
         ...
         - UCW SDK 1
          ...
          - Client Apps 2, 3 → UCW SDK 2, 3
            ...
            26. Client Apps 2 and 3 retrieve the pending TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
          ...
          - Client Apps 2, 3 → UCW SDK 2, 3
            ...
            29. After review, Client Apps 2 and 3 approve the TSS request by calling the [Approve TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/approve-tss-requests) operation.
        ...
        - **Finalize the TSS request for key generation**
          ...
          - Client App 1 → UCW SDK 1
            ...
            35. Client App 1 retrieves the status of the TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
          ...
          - Client Apps 2, 3 → UCW SDK 2, 3
            ...
            38. Client Apps 2 and 3 retrieve the status of the TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
            ...
            - Cobo Backend → Client Backend
              ...
              42. Client Backend receives the key generation result through webhook or polling.
                     ...
                     - **Polling option**
                       ...
                       Client Backend polls the Cobo Backend to retrieve the final result by calling the [Get TSS request](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
    ...
    #### Sequence of operations
        ...
        - **Initialize UCW SDK 4 in Client App 4**
          ...
          - Client App 4 → UCW SDK 4
            ...
            1. Client App 4 initiates its UCW SDK instance by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) operation.
          ...
          - Client App 4 → UCW SDK 4
            ...
            3. Client App 4 requests the TSS Node ID by calling the [Get TSS Node ID](/v2/developer-tools/ucw-sdk/ucwpublic-class/get-tss-node-id) operation.
        ...
        - **Select and submit a Recovery Group**
          ...
          - Client Backend → Cobo Backend
            ...
            9. Client Backend forwards the request to the Cobo Backend by calling the [Create key share holder group](/v2/api-references/wallets--mpc-wallets/create-key-share-holder-group) operation and creating a Main Group.
          ...
          - Client Backend → Cobo Backend
            ...
            11. Client Backend submits a request to the Cobo Backend to initiate a key generation request by calling the [Create TSS requests](/v2/api-references/wallets--mpc-wallets/create-tss-request) operation and specifying `Recovery` as the `type`.
          ...
          - Cobo Backend → Client Backend
            ...
            16. Client Backend monitors the TSS request status through webhooks or polling.
                ...
                - **Polling option**
                  ...
                  Client Backend polls the TSS request status by calling the [Get TSS request](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
        ...
        - **Review and approve TSS requests**
          ...
          - Client App 2, 3 → UCW SDK 2, 3
            ...
            23. Client Apps 2 and 3 retrieve the pending TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
          ...
          - Client App 2, 3 → UCW SDK 2, 3
            ...
            26. After reviewing the request, Client Apps 2 and 3 approve it by calling the [Approve TSS request](/v2/developer-tools/ucw-sdk/ucw-class/approve-tss-requests) operation.
          ...
          - Client App 4 → UCW SDK 4
            ...
            28. Client Apps 4 retrieves the pending TSS request by calling the [Get TSS requests](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
          ...
          - Client App 4 → UCW SDK 4
            ...
            31. After reviewing the request, Client App 4 approves it by calling the [Approve TSS request](/v2/developer-tools/ucw-sdk/ucw-class/approve-tss-requests) operation.
        ...
        - **Finalize the TSS request**
          ...
          - Client Apps 2, 3, 4 → UCW SDK 2, 3, 4
            ...
            37. (37 & 40) Client Apps 2, 3, and 4 retrieve the TSS request status by calling the [Get TSS request](/v2/developer-tools/ucw-sdk/ucw-class/get-tss-requests) operation.
            ...
            - Cobo Backend → Client Backend
                  ...
                  44. Client Backend receives TSS request result through webhooks or polling.
                         ...
                         - **Polling option**
                           ...
                           Client Backend polls the final key generation result by calling the [Get TSS requests](/v2/api-references/wallets--mpc-wallets/get-tss-request) operation.
    ...
    #### Sequence of operations
        ...
        - **Export key shares of Client App 3**
          ...
          - Client App 3 → UCW SDK 3
            ...
            3. Client App 3 opens its UCW SDK 3 instance by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) operation.
          ...
          - Client App 3 → UCW SDK 3
            ...
            5. Client App 3 exports its recovery key shares using a passphrase for encryption by calling the [Export recovery key shares](/v2/developer-tools/ucw-sdk/ucw-class/export-recovery-key-shares) operation.
        ...
        - **Export key shares of Client App 2**
          ...
          - Client App 2 → UCW SDK 2
            ...
            7. Client App 2 opens its UCW SDK 2 instance by calling the [Create UCW class](/v2/developer-tools/ucw-sdk/ucw-class/create-ucw) operation.
          ...
          - Client App 2 → UCW SDK 2
            ...
            9. Client App 2 exports its recovery key shares using a passphrase for encryption by calling the [Export recovery key shares](/v2/developer-tools/ucw-sdk/ucw-class/export-recovery-key-shares) operation.
        ...
        - **Initiate key recovery in Client App 2**
          ...
          - Client App 2 → UCW SDK 2
            ...
            11. Client App 2 opens a UCWRecoverKey instance in UCW SDK 2 by calling the [Create UCW recover key](/v2/developer-tools/ucw-sdk/ucwrecoverkey-class/create-ucw-recover-key) operation.
        ...
        - **Import key shares from Client Apps 2 and 3**
          ...
          - Client App 2 → UCW SDK 2
            ...
            13. Client App 2 imports the recovery key shares from UCW SDK 2's exported passphrase-encrypted JSON data of key shares by calling the [Import recovery key share](/v2/developer-tools/ucw-sdk/ucwrecoverkey-class/import-recovery-key-share) operation and passing in UCW SDK 2's exported passphrase-encrypted JSON data of key shares.
          ...
          - Client App 2 → UCW SDK 3
            ...
            15. Client App 2 imports the recovery key shares from UCW SDK 3's exported passphrase-encrypted JSON data of key shares by calling the [Import recovery key share](/v2/developer-tools/ucw-sdk/ucwrecoverkey-class/import-recovery-key-share) operation and passing in UCW SDK 3's exported passphrase-encrypted JSON data of key shares
        ...
        - **Recover the root extended private key**
          ...
          - Client App 2 → UCW SDK 2
            ...
            17. After importing the key shares, Client App 2 initiates the recovery of the full root extended private key for the specified address by calling the [Recovery private key](/v2/developer-tools/ucw-sdk/ucwrecoverkey-class/recover-private-keys) operation.
