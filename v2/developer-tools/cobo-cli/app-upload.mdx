...
Use the `upload` command to publish your Cobo Portal Apps to Cobo Portal. For more details about publish Cobo Portal Apps, refer to [Publish the app](/v2/apps/build-app#publish-the-app).
