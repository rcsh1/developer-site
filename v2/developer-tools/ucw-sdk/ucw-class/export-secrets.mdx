...
icon: ""
description: "This operation exports the Secrets file as a passphrase-encrypted JSON data of TSS Nodes. You can then use the [Import Secrets](/v2/developer-tools/ucw-sdk/other-apis/import-secrets) operation to restore the Secrets file."
---
