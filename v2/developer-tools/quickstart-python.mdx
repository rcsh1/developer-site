...
1. Install the SDK using the pip install command.
   ...
   ```
  <Note>Replace \{VERSION\} with the lastest version number, for example, `1.2.0`. Obtain the latest version number from the <a href="https://github.com/CoboGlobal/cobo-waas2-python-sdk/tags">GitHub repository</a>.</Note>
