...
<Note>It's recommended that you use the latest version of the WaaS SDK. See the [GitHub repository](https://github.com/CoboGlobal/cobo-waas2-python-sdk/tags) for the latest version.</Note>
