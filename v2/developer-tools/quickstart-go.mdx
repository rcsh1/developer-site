...
2. In the `go.mod` file of your project, add the following line:
    ...
    ```go
    require github.com/CoboGlobal/cobo-waas2-go-sdk v1.1.0
    ```

    <Note>It's recommended that you use the latest version of the WaaS SDK. See the tags in the <a href="https://github.com/CoboGlobal/cobo-waas2-go-sdk/tags">GitHub repository</a>.</Note>
