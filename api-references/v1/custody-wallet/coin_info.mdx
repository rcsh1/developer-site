...
<ParamField query="amount" type="Int">the amount you wish to send(To accurately estimate handling fees, it is necessary to include the amount parameter)</ParamField>
