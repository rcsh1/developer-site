...
<Tip> FAQ：[How to query the transaction details of a batch withdraw request?](/faqs/transaction-management#how-to-query-the-transaction-details-of-a-batch-withdrawal-request)</Tip>
