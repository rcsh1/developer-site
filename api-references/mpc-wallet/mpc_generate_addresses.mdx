...
<Tip> FAQ：[How to batch-generate addresses?](/faqs/address-management#how-to-batch-generate-addresses)</Tip>
      ...
      <Expandable title="object">
        <ResponseField name="addresses" type="object[]">
            <Expandable title="object">
                ...
                <ResponseField name="encoding" type="Int" >The encoding of the generated address. For more information, please [refer to](/api-references/development/address-encoding) the enum value corresponding to each encoding</ResponseField>
            </Expandable>
        </ResponseField>
      </Expandable>
</ResponseField>
