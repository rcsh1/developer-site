---
title: Babylon Update Staking Fee
api: POST /v1/custody/mpc/babylon/update_staking_fee/
contentType: multipart/form-data
description: "This endpoint specify the pre-signed staking transaction, update the corresponding transaction fee to create a new transaction, accepting parameters such as `request_id`, `related_request_id`, `fee_rate`, and `max_staking_fee`."
---
...
request(
    "POST",
    "/v1/custody/mpc/babylon/update_staking_fee/",
    {
...
coboFetch('POST', '/v1/custody/mpc/babylon/update_staking_fee/', {
    "request_id": "1717059604245",
    "related_request_id": "1717059601673",
    "fee_rate": 9.5,
    "max_staking_fee": 2000
...
```
```go Go
Request("POST", "/v1/custody/mpc/babylon/update_staking_fee/", map[string]string{
    "request_id": "1717059604245",
    "related_request_id": "1717059601673",
    "fee_rate": 9.5,
    "max_staking_fee": 2000
