...
description: "This endpoint is used to query all unbroadcasted pre-signed staking transactions based on the provided parameter `asset_coin` and `address`"
---

#### Request
<ParamField body="asset_coin" type="String" required>code of the staking token</ParamField>
<ParamField body="address" type="String" required>staking address</ParamField>
