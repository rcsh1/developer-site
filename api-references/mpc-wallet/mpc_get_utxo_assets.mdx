...
description: "This endpoint returns a JSON response containing the asset information within the given UTXO. These assets include BRC-20, BRC-420, and NFTs, among others."
