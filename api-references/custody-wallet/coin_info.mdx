...
<Tip>To accurately estimate handling fees, it is necessary to include the amount parameter. Otherwise, this endpoint will return the default transaction fee. Please note that the default transaction fee might not be very accurate.</Tip>
