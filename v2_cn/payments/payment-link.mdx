...
3. 在第三方钱包列表选择钱包并完成支付。
4. 页面将自动跳转至支付成功页面。
<img src="/v2_cn/images/payments/payment-link-mobile.png" className="screenshot_full_screen" alt="移动端 支付链接 页面" />
...
3. 在第三方钱包列表选择钱包并完成支付。
4. 页面将自动跳转至支付成功页面。
<img src="/v2_cn/images/payments/payment-link-desktop.png" className="screenshot_full_screen" alt="PC 支付链接 页面" />
...
<img src="/v2_cn/images/payments/payment-link-demo-page.png" className="screenshot_full_screen" alt="支付链接 Demo 页面" />
...
<img src="/v2_cn/images/payments/payment-link-request.png" className="screenshot_full_screen" alt="支付链接 预下单请求" />
