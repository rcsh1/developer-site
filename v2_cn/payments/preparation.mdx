...
### 订单模式
- [创建订单](/v2_cn/payments/create-orders)：了解如何创建支付订单
- [结算](/v2_cn/payments/settle-orders)：了解如何结算商户余额和开发者余额
- [异常处理](/v2_cn/payments/handle-abnormality-order)：了解如何处理多付、少付、退款等异常情况

### 充值模式  
- [获取充值地址](/v2_cn/payments/get-topup-addresses)：了解如何创建充值地址
- [结算](/v2_cn/payments/settle-topup)：了解如何结算充值模式下的资金
- [异常处理](/v2_cn/payments/handle-abnormality-topup)：了解如何处理地址更换、合规异常等情况
