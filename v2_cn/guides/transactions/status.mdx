...
<table className="table-three-cols">
  ...
  <tr>
    <td>PendingTransactionPolicyCheck</td>
    <td>交易正在等待交易风控检查。</td>
  </tr>
  <tr>
    <td rowspan="18">PendingSignature</td>
    <td>Queue</td>
  ...
  <tr>
    <td rowspan="2">Broadcasting</td>
    <td>FailedBroadcasting</td>
    <td>交易未能广播到区块链网络。</td>
  </tr>
  <tr>
    <td>Queued</td>
    <td>交易已排队等待广播到区块链网络。</td>
  </tr>
  <tr>
