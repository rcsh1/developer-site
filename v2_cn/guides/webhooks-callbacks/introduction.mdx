...
要注册Endpoint，请参阅 [注册 Webhook Endpoint](https://manuals.cobo.com/zh/portal/developer-console/webhooks-create) 和 [注册Callback Endpoint](https://manuals.cobo.com/zh/portal/developer-console/callbacks-register)。
...
- 按照 [注册 Webhook Endpoint](https://manuals.cobo.com/zh/portal/developer-console/webhooks-create) 或 [注册 Callback Endpoint](https://manuals.cobo.com/zh/portal/developer-console/callbacks-register) 中的说明在 Cobo Portal 上注册Endpoint。
