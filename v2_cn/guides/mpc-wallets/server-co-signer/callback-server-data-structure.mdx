...
description: TSS Node Callback服务器交互中使用的 Payload 格式的详细规范
---
...
| staking_activity | `object` | 如果交易是质押活动，则为质押活动的信息。详情请参阅[获取质押活动详情](/v2/api-references/stakings/get-staking-activity-details)操作的响应。 |
...
| 字段 | 类型 | 描述 |
|-------|------|-------------|
| old_group_id | `string` | 现有私钥分片持有者组的 ID。 |
